...
namespace RT.ArithmeticCoding
{
    ...
    public class ArithmeticCodingReaderStream : Stream
    {
        ...
        /// <summary>
        ///     Decodes no more than <paramref name="count"/> bytes into the specified <paramref name="buffer"/>, populating
        ///     the array from <paramref name="offset"/> onwards.</summary>
        /// <returns>
        ///     The number of bytes read. This can be less than <paramref name="count"/>. Returns 0 if and only if there are
        ///     no further bytes to be decoded.</returns>
        ...
        ///     read additional data from the input stream, but it is optional otherwise.</summary>
